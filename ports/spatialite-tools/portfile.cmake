...
if (VCPKG_TARGET_IS_WINDOWS)
  if(VCPKG_CRT_LINKAGE STREQUAL dynamic)
      ...
      set(SPATIALITE_LIBS_DBG "${CURRENT_INSTALLED_DIR}/debug/lib/spatialited.lib")
      set(ICONV_LIBS_REL "${CURRENT_INSTALLED_DIR}/lib/iconv.lib")
      set(ICONV_LIBS_DBG "${CURRENT_INSTALLED_DIR}/debug/lib/iconvd.lib")
      ...
      set(TIFF_LIBS_REL "${CURRENT_INSTALLED_DIR}/lib/tiff.lib")
      set(TIFF_LIBS_DBG "${CURRENT_INSTALLED_DIR}/debug/lib/tiffd.lib")
  else()
      set(CL_FLAGS "/DXML_STATIC")
      ...
      set(SPATIALITE_LIBS_DBG "${CURRENT_INSTALLED_DIR}/debug/lib/spatialited.lib ${CURRENT_INSTALLED_DIR}/debug/lib/freexl.lib ${CURRENT_INSTALLED_DIR}/debug/lib/librttopo.lib")
      set(ICONV_LIBS_REL "${CURRENT_INSTALLED_DIR}/lib/libiconv.lib ${CURRENT_INSTALLED_DIR}/lib/libcharset.lib")
      set(ICONV_LIBS_DBG "${CURRENT_INSTALLED_DIR}/debug/lib/libiconvd.lib ${CURRENT_INSTALLED_DIR}/debug/lib/libcharsetd.lib")
      set(EXPAT_LIBS_REL "${CURRENT_INSTALLED_DIR}/lib/libexpat.lib")
      set(EXPAT_LIBS_DBG "${CURRENT_INSTALLED_DIR}/debug/lib/libexpatd.lib")
      set(TIFF_LIBS_REL "${CURRENT_INSTALLED_DIR}/lib/tiff.lib")
      set(TIFF_LIBS_DBG "${CURRENT_INSTALLED_DIR}/debug/lib/tiffd.lib")
  ...
  set(LIBS_ALL_DBG
      "${CURRENT_INSTALLED_DIR}/debug/lib/sqlite3d.lib \
