...
function(vcpkg_configure_cmake)
    ...
    if(DEFINED VCPKG_CMAKE_SYSTEM_NAME AND NOT VCPKG_CMAKE_SYSTEM_NAME STREQUAL CMAKE_HOST_SYSTEM_NAME)
        # UPSTREAM MOD: only append system name if it does not match the host system name, otherwise we are cross compiling
    ...
    if (VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
        ...
        list(APPEND _csc_OPTIONS "-DCMAKE_CROSSCOMPILING_EMULATOR=${NODEJS}")
    endif ()
