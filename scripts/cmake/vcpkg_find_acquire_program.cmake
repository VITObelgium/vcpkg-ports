...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "NINJA")
    set(PROGNAME ninja)
    set(SUBDIR "ninja-1.10.2")
    if(CMAKE_HOST_WIN32)
      set(PATHS "${DOWNLOADS}/tools/ninja/${SUBDIR}")
      set(URL "https://github.com/ninja-build/ninja/releases/download/v1.10.2/ninja-win.zip")
      set(ARCHIVE "ninja-win-1.10.2.zip")
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "FreeBSD")
      ...
      set(URL "https://github.com/ninja-build/ninja/releases/download/v1.10.2/ninja-linux.zip")
      set(ARCHIVE "ninja-linux-1.10.2.zip")
  ...
  elseif(VAR MATCHES "LLVM")
    ...
    if(CMAKE_HOST_WIN32)
      ...
      set(URL "https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.1/LLVM-11.0.1-win64.exe")
      set(ARCHIVE "LLVM-11.0.1-win64.exe")
      set(HASH c86a70437d99472b3c6a5fe7a97f8c43b3ca987f5e7ac78ae385b2c52c40613d7e8b9644deb1f4733b24f217b5825ad8d9a2019d244c63dd6e2ab1a97ef98f55)
  ...
  if("${${VAR}}" MATCHES "-NOTFOUND")
    ...
    if(DEFINED NOEXTRACT)
      ...
      if(DEFINED CUSTOM_EXTRACT_COMMAND)
        vcpkg_execute_required_process(
          COMMAND ${CUSTOM_EXTRACT_COMMAND}
          WORKING_DIRECTORY ${PROG_PATH_SUBDIR}
          LOGNAME ${VAR}-tool-extract
        )
      else ()
