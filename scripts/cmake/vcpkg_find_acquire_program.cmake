...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "LLVM")
    set(PROGNAME clang++)
    if(CMAKE_HOST_WIN32)
      vcpkg_find_acquire_program(7Z)
      set(PATHS ${DOWNLOADS}/tools/clang++/bin)
      set(URL "https://github.com/llvm/llvm-project/releases/download/llvmorg-12.0.0/LLVM-12.0.0-win64.exe")
      set(ARCHIVE "LLVM-12.0.0-win64.exe")
      set(HASH 67a9b54abad5143fa5f79f0cfc184be1394c9fc894fa9cee709943cb6ccbde8f0ea6003d8fcc20eccf035631abe4009cc0f694ac84e7879331cebba8125e4c7f)
      set(CUSTOM_EXTRACT_COMMAND ${7Z} x ${DOWNLOADS}/${ARCHIVE})
    endif ()
  else()
