...
function(vcpkg_test_cmake)
    ...
    message(STATUS "${CMAKE_COMMAND} -G ${GENERATOR} ${GENERATOR_OPTIONS} -C ${VCPKG_ROOT_DIR}/triplets/${TARGET_TRIPLET}.cmake -DCMAKE_TOOLCHAIN_FILE=${VCPKG_ROOT_DIR}/scripts/buildsystems/vcpkg.cmake -DVCPKG_CHAINLOAD_TOOLCHAIN_FILE=${CHAINLOAD_FILE} -DVCPKG_TARGET_TRIPLET=${TARGET_TRIPLET} -DVCPKG_APPLOCAL_DEPS=OFF -DCMAKE_FIND_ROOT_PATH=${CURRENT_PACKAGES_DIR} -DCMAKE_MODULE_PATH=${CURRENT_PACKAGES_DIR}/share/cmake;${CURRENT_INSTALLED_DIR}/share/cmake .")

    execute_process(
      COMMAND ${CMAKE_COMMAND} -G ${GENERATOR} ${GENERATOR_OPTIONS} -C ${VCPKG_ROOT_DIR}/triplets/${TARGET_TRIPLET}.cmake -DCMAKE_TOOLCHAIN_FILE=${VCPKG_ROOT_DIR}/scripts/buildsystems/vcpkg.cmake -DVCPKG_CHAINLOAD_TOOLCHAIN_FILE=${CHAINLOAD_FILE} -DVCPKG_TARGET_TRIPLET=${TARGET_TRIPLET} -DVCPKG_APPLOCAL_DEPS=OFF -DCMAKE_FIND_ROOT_PATH=${CURRENT_PACKAGES_DIR} -DCMAKE_MODULE_PATH=${CURRENT_PACKAGES_DIR}/share/cmake;${CURRENT_INSTALLED_DIR}/share/cmake .
