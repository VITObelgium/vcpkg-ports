...
function(vcpkg_test_cmake)
    ...
    if(VCPKG_VERBOSE)
      message(STATUS "${CMAKE_COMMAND} -G ${GENERATOR} ${ARCH} ${MAKE_PROGRAM_ARG} -DCMAKE_TOOLCHAIN_FILE=${VCPKG_ROOT_DIR}/scripts/buildsystems/vcpkg.cmake -DVCPKG_TARGET_TRIPLET=${TARGET_TRIPLET} -DVCPKG_APPLOCAL_DEPS=OFF -DCMAKE_FIND_ROOT_PATH=${CURRENT_PACKAGES_DIR} -DCMAKE_MODULE_PATH=${CURRENT_PACKAGES_DIR}/share/cmake;${CURRENT_INSTALLED_DIR}/share/cmake .")
    endif()

    execute_process(
      COMMAND ${CMAKE_COMMAND} -G ${GENERATOR} ${ARCH} ${MAKE_PROGRAM_ARG} -DCMAKE_TOOLCHAIN_FILE=${VCPKG_ROOT_DIR}/scripts/buildsystems/vcpkg.cmake -DVCPKG_TARGET_TRIPLET=${TARGET_TRIPLET} -DVCPKG_APPLOCAL_DEPS=OFF -DCMAKE_FIND_ROOT_PATH=${CURRENT_PACKAGES_DIR} -DCMAKE_MODULE_PATH=${CURRENT_PACKAGES_DIR}/share/cmake;${CURRENT_INSTALLED_DIR}/share/cmake .
