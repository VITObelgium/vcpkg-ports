if(NOT _VCPKG_WINDOWS_TOOLCHAIN)
    ...
    if(NOT _CMAKE_IN_TRY_COMPILE)
        if(VCPKG_CLANG)
            ...
            set(CMAKE_CXX_FLAGS "/nologo /DWIN32 /D_WINDOWS /W3 ${CHARSET_FLAG} /GR /EHsc ${MP_FLAG} ${VCPKG_CXX_FLAGS}" CACHE STRING "")
            set(CMAKE_C_FLAGS "/nologo /DWIN32 /D_WINDOWS /W3 ${CHARSET_FLAG} ${MP_FLAG} ${VCPKG_C_FLAGS}" CACHE STRING "")
            ...
            set(CMAKE_Fortran_FLAGS_RELEASE "/O2 ${VCPKG_CRT_LINK_FLAG_PREFIX} /nodebug" CACHE STRING "")
