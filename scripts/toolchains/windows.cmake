if(NOT _VCPKG_WINDOWS_TOOLCHAIN)
    ...
    if(NOT _CMAKE_IN_TRY_COMPILE)
        if(VCPKG_CLANG)
            ...
            if(VCPKG_INTEL_ONEAPI)
                set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "/nologo /DEBUG ${VCPKG_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS_RELEASE}" CACHE STRING "")
                set(CMAKE_EXE_LINKER_FLAGS_RELEASE "/nologo /DEBUG ${VCPKG_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS_RELEASE}" CACHE STRING "")
            else()
                set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "/nologo /DEBUG /OPT:REF /OPT:ICF ${VCPKG_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS_RELEASE}" CACHE STRING "")
                set(CMAKE_EXE_LINKER_FLAGS_RELEASE "/nologo /DEBUG /MANIFEST:NO /OPT:REF /OPT:ICF ${VCPKG_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS_RELEASE}" CACHE STRING "")
            endif()
            ...
            string(APPEND CMAKE_EXE_LINKER_FLAGS_DEBUG_INIT " /nologo /MANIFEST:NO ${VCPKG_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS_DEBUG} ")
        endif()
    endif()
endif()
