...
if(NOT INTEL_INSTALL_PATH)
    set(INTEL_INSTALL_PATH /tools/toolchains/intel/oneapi/compiler/latest/linux)
endif()

set(INTEL_PATH ${INTEL_INSTALL_PATH}/bin/)
set(INTEL_LLVM_PATH ${INTEL_INSTALL_PATH}/bin-llvm/)
...
set(HAVE_LIBM "${INTEL_INSTALL_PATH}/compiler/lib/intel64_lin/libimf.a" CACHE FILEPATH "")
#set(CMAKE_EXE_LINKER_FLAGS "-static-intel -static-libstdc++ ${VCPKG_LINKER_FLAGS}" CACHE STRING "" FORCE)
